  ...
  return (
    <section className="item-section">
      ...
      <div className="item-profile__subsection">
        <div className="item-profile__subheading"><div><p>TYPE-SPECIFIC ADJUSTMENTS</p><h4>Damage Modifiers</h4></div><button type="button" onClick={() => update({ damageModifiers: [...profile.damageModifiers, { modifierText: "", damageType: "", modifier: "", notes: "", sortOrder: profile.damageModifiers.length }] })}>Add Modifier</button></div>
